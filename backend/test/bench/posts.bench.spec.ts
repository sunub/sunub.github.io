...
describe("PostsService Benchmark: Lazy (User) vs Eager (Native)", () => {
    ...
    it("Comparison: Initial Index Building (Cold Start)", async () => {
        ...
        console.log(`[User Logic] Index Build Time: ${(endLazy - startLazy).toFixed(2)}ms`);
        console.log(`[User Logic] Memory Delta: ${(endMemLazy - startMemLazy).toFixed(2)} MB`);
        ...
        console.log(`[Native Logic] Index Build Time: ${(endNative - startNative).toFixed(2)}ms`); 
        console.log(`[Native Logic] Memory Delta: ${(endMemNative - startMemNative).toFixed(2)} MB`);
    ...
    it("Comparison: Querying (Find Latest 100)", async () => {
        ...
        console.log(`[User Logic] Query Time: ${(endLazy - startLazy).toFixed(2)}ms`);
        console.log(`[Native Logic] Query Time: ${(endNative - startNative).toFixed(2)}ms`);
    });
});

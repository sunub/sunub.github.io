...
export function TopClouds() {
  return (
    ...
    >
      <CloudSvg fillFront="var(--color-endStart)" fillBack="var(--color-midStart)" />
      <Wrapper $backgroundColor="var(--color-midStart)" />
    </TopCloudWrapper>
  );
}

function CloudSvg({ minWidth, fillFront, fillBack }: { minWidth?: number; fillFront?: string; fillBack?: string }) {
  return (
    <SVG
      width="5120"
      height="357"
...
const TopCloudWrapper = styled(motion.div)`
  position: absolute;
  left: 0;
  right: 0;
  top: 0;

...
export function DarkWave({ ...delegated }) {
  return (
    <Styled.WaveSvgWrapper key={'dark-wave-svg'} {...delegated}>
      <Styled.WaveSvg
      ...
      >
        <path
          ...
          fill="url(#paint0_linear_116_748)"
        />
        <path
          ...
          fill="url(#paint1_linear_116_748)"
        />
        <path
        ...
        <defs>
          ...
          >
            ...
            <stop offset="0.690427" stopColor="var(--color-midStop)" />
          </linearGradient>
          <linearGradient id="paint1_linear_116_748" x1="720" y1="46" x2="720" y2="196" gradientUnits="userSpaceOnUse">
            <stop offset="0.133996" stopColor="var(--color-endStart)" stopOpacity="0.35" />

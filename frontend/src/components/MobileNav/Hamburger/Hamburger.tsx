...
type MobileNavProps = React.ComponentProps<
	typeof import("../MobileNav")["default"]
>;

const loadMobileNav = () => import("../MobileNav");

const MobileNav = dynamic<MobileNavProps>(loadMobileNav, {
	ssr: false,
});
...
function Hamburger() {
	...
	const floodWrapperRef = React.useRef<HTMLDivElement>(null);
...
function UnfilledSVG({ refObjects }: { refObjects: RefObjects }) {
	...
	return (
		<Styled.FloodWrapper ref={floodWrapperRef}>
			<Styled.FloodSVG
				width="469"
				height="1133"

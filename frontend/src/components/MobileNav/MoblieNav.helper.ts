...
const openInBetweenAnimation = (refObjects: RefObjects, timeline: GSAPTimeline) => {
  const { pathStartRef, pathMidRef, pathEndRef, gradientRef, svgRef } = refObjects;
...
const openFilledAnimation = (refObjects: RefObjects, timeline: GSAPTimeline) => {
...
const closeInBetweenAnimation = (refObjects: RefObjects, timeline: GSAPTimeline) => {
  const { pathStartRef, pathMidRef, pathEndRef, gradientRef } = refObjects;
...
const closeUnfilledAnimation = (refObjects: RefObjects, timeline: GSAPTimeline) => {

...
export const POST_ARCHIVE_PRELOAD_THRESHOLD_MULTIPLIER = 0.65;
export const POST_ARCHIVE_PRELOAD_RESERVE_MULTIPLIER = 1.2;
export const POST_ARCHIVE_MIN_PRELOAD_THRESHOLD_PX = 220;
export const POST_ARCHIVE_MIN_PRELOAD_RESERVE_PX = 280;
export const POST_ARCHIVE_MAX_PRELOAD_RESERVE_PX = 640;

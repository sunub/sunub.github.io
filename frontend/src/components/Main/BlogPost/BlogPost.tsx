...
export function BlogPost({ initialPosts }: { initialPosts: Promise<PublishedPost> }) {
  ...
  return (
    <Styled.BlogPostList id="blog-post__recently-post-list">
      {publishedPost.frontmattters.map(post => {
        ...
        return (
          <Styled.BlogPostListItem key={`${category}-${slug}-${date}`} className="blog-post__recently-post-item">
...
function UnderLineWaveSVG() {
  return (
    <Styled.UnderLineWaveSVG xmlns="http://www.w3.org/2000/svg" width="94" height="11" fill="none">

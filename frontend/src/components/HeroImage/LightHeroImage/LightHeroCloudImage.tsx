...
export function LightCloudHeroImage() {
  ...
  return (
    <AnimationWindow style={cloudStyle}>
      <AnimationTrack>
        <AutoWidthImage src={LightHeroCloudImage} alt="light clouds" priority sizes="100vw" />
        <AutoWidthImage src={LightHeroCloudImage} alt="light clouds loop 1" priority sizes="100vw" />
        <AutoWidthImage src={LightHeroCloudImage} alt="light clouds loop 2" priority sizes="100vw" />
      </AnimationTrack>
    </AnimationWindow>
  );
}

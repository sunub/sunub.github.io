...
const path = {
  step1: {
    end: "M1252.27 19.4939C1338.33 -14.5752 1425.94 42.9589 1440 42.9589L1440 196H0V31.3242C73.125 31.3242 177.891 19.4939 302.344 2.45937C426.797 -14.5752 506.25 62.0803 662.344 72.839C818.437 83.5976 847.266 1.11453 952.735 31.5974C1058.2 62.0803 1144.69 62.0803 1252.27 19.4939Z",
  ...
  step2: {
    end: "M1252.27 56C1300 89.4424 1440 -8.5 1440 50.358V211.945H0V38.0736C157 -58.0001 177.891 62.4862 302.344 44.5005C426.797 26.5148 520.5 74.5 662.344 36.5C728 18.9108 883.5 80.362 952.735 61.5C1044.5 36.5 1159.5 -9 1252.27 56Z",
    mid: "M187.734 71.5005C103.5 71.5005 40 125 0 78.0006V212.376H1440V100C1366.88 100 1333 105 1232.58 77.5005C1169 60.0891 1011 96.0005 968.203 110.5C925.406 125 879 74.5107 777.656 92.0005C627 118 550.5 98.5005 487.266 125C436.5 146.275 262.5 71.5005 187.734 71.5005Z",
    front:
      "M187.734 137.132C123 161.314 72.5 64.6318 0 137.132V211.568H1440V139.5C1386.5 185.5 1171.67 130 1137.66 130C1082 130 895 156.356 777.656 141C621 120.5 593 126.269 491 159C383.15 193.609 296.5 96.5003 187.734 137.132Z",
  },
};
...
function WaveSvg({ ...delegated }) {
  ...
  React.useEffect(() => {
    const tl = gsap.timeline({ paused: true, repeat: Infinity });
  }, []);

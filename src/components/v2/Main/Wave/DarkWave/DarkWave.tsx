    ...
    <Styled.WaveSvgWrapper key={"dark-wave-svg"} {...delegated}>
      ...
      >
        ...
        <defs>
          ...
          >
            <stop offset="0.457674" stopColor="#E5E1FE" />
            <stop offset="0.690427" stopColor="#7768D0" />
          </linearGradient>
          <linearGradient
            id="paint1_linear_116_748"
            x1="720"
            y1="46"
            x2="720"
            y2="196"
            gradientUnits="userSpaceOnUse"
          >
            <stop offset="0.133996" stopColor="#7769D1" stopOpacity="0.35" />
            <stop offset="0.690268" stopColor="#40367A" />
          </linearGradient>
        </defs>
      </Styled.WaveSvg>
